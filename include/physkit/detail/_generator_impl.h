...
public:
    template <typename... _Args>
    static void *operator new(std::size_t __frameSize, std::allocator_arg_t, _Alloc __alloc,
                              _Args &...)
    {
    ...
    static void *operator new(std::size_t __frameSize, _This &, std::allocator_arg_t,
...
template <typename _Ref> struct __generator_promise_base
{
    ...
    {
        if (__root_ != this) { __exception_.get() = std::current_exception(); }
        else
        {
            throw;
        }
    ...
    {
        return [](std::allocator_arg_t, _Allocator alloc,
                  auto &&__rng) -> generator<_Ref, std::remove_cvref_t<_Ref>, _Allocator>
        {
            for (auto &&e : __rng) co_yield static_cast<decltype(e)>(e);
        }(std::allocator_arg, __x.allocator, std::forward<_Rng>(static_cast<_Rng &&>(__x.range)));
    }
...
struct __generator_promise<generator<_Ref, _Value, _Alloc>, _ByteAllocator, _ExplicitAllocator>
    final : public __generator_promise_base<_Ref>, public __promise_base_alloc<_ByteAllocator>
{
    ...
    yield_value(std::ranges::elements_of<_Rng> &&__x)
    {
        static_assert(!_ExplicitAllocator,
                      "This coroutine has an explicit allocator specified with std::allocator_arg "
                      "so an allocator needs to be passed "
                      "explicitely to std::elements_of");
        return [](auto &&__rng) -> generator<_Ref, _Value, _Alloc>
        {
            for (auto &&e : __rng) co_yield static_cast<decltype(e)>(e);
        }(std::forward<_Rng>(static_cast<_Rng &&>(__x.range)));
    }
};
} // namespace generator_impl
namespace std
...
struct coroutine_traits<generator_impl::generator<_Ref, _Value>, _Args...>
{
    using promise_type =
        generator_impl::__generator_promise<generator_impl::generator<_Ref, _Value>,
...
struct coroutine_traits<generator_impl::generator<_Ref, _Value>, std::allocator_arg_t, _Alloc,
                        _Args...>
{
private:
...
public:
    using promise_type =
        generator_impl::__generator_promise<generator_impl::generator<_Ref, _Value>,
                                            __byte_allocator, true /*explicit Allocator*/>;
};
...
struct coroutine_traits<generator_impl::generator<_Ref, _Value>, _This, allocator_arg_t, _Alloc,
                        _Args...>
{
private:
    using __byte_allocator = __byte_allocator_t<_Alloc>;
...
template <typename _Ref, typename _Value, typename _Alloc, typename... _Args>
struct coroutine_traits<generator_impl::generator<_Ref, _Value, _Alloc>, _Args...>
{
    using __byte_allocator = __byte_allocator_t<_Alloc>;

public:
    using promise_type =
        generator_impl::__generator_promise<generator_impl::generator<_Ref, _Value, _Alloc>,
                                            __byte_allocator>;
};
...
{
    using __byte_allocator = std::__byte_allocator_t<_Alloc>;
...
constexpr inline bool enable_view<generator_impl::generator<_T, _U, _Alloc>> = true;
