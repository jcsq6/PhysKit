// control sets for the PhysKit official sandbox
...
// to return console fps, selected object, speed, mass density, restitution, friction

// work on camera movement, picking, collision logging, and gjk depth
